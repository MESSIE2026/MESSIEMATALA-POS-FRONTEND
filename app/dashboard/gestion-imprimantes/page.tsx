      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 lg:col-span-2">
            <h2 className="text-xl font-bold text-slate-900">⚙️ Imprimantes configurées ZAIRE POS</h2>
                ...
                <tbody>
                  {imprimantes.map((item) => (
                    <tr key={item.id_imprimante} className="border-b">
                      ...
                      <td>
                        <span className={item.actif ? 'text-emerald-700 font-bold' : 'text-red-600 font-bold'}>
                          {item.actif ? '🟢 Active' : '🔴 Désactivée'}
                        </span>
                      </td>
